...
###Write them out!
<img src="slide_img/dplyr_hex.jpg" width=30%>
<img src="slide_img/dplyr_verbs.jpg" width=60%>
---
...
###Here's our .yellow[wide] format data:
```{r echo=F}
data <- tibble(
...
data
```
###Go from .yellow[wide] to .yellow[long] format with `tidyr::gather()`
```{r}
plot_data <- data %>%
  select(-subject_ID) %>%
...
.center[<img src="slide_img/rmarkdown_universe.jpg" width=100%>]
---
class: bg-main1
...
<img src="slide_img/twitter.jpg" width=15%>
<img src="slide_img/stack_overflow.png" width=20%>
<img src="slide_img/R_ladies.png" width=15%>
</br>
</br>
